...
server.post('/auction_object/new_auction_object', async (request, response)=>{
    ...
    await db.run(query, [request.body.saljare, request.body.beskrivning, request.body.titel, request.body.start_tid, request.body.slut_tid, request.body.bild, request.body.start_pris, request.body.dold_slutpris, request.body.status])
